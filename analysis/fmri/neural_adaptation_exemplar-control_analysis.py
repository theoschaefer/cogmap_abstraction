...
# -*- coding: utf-8 -*-
##===========================================================================##
#            Neural Adaptation Analysis - Exemplar Modulation Control
#
...
fn_img_pval = path_data / 'modulation-prototype&exemplar_contrast-prototype_mask-hpc_logp-max-tfce.nii.gz'
fn_img_tval = path_data / 'modulation-prototype&exemplar_contrast-prototype_mask-hpc_t.nii.gz'
...
fn_img_pval = path_data / 'modulation-prototype&exemplar_contrast-exemplar_mask-hpc_logp-max-tfce.nii.gz'
fn_img_tval = path_data / 'modulation-prototype&exemplar_contrast-exemplar_mask-hpc_t.nii.gz'
